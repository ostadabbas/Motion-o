#!/bin/bash
# GRPO Training with Motion Chain of Thought (MCoT)
# Uses motion-augmented dataset with <motion> tags + motion_trajectory reward
...
# Configuration
MODEL_PATH="outputs/sft_mcot_test"  # Use MCoT SFT checkpoint
EXP_NAME="grpo_mcot_test"
OUT_DIR="outputs/${EXP_NAME}"

# Use same RL dataset as baseline (with tracking data for motion rewards)
DATA_ROOT="/mnt/data/stgr"
DATASET_JSON="${DATA_ROOT}/json_data/STGR-RL-subset.json"

echo "=========================================="
echo "Starting GRPO Training with MCoT"
echo "=========================================="
echo "Model: $MODEL_PATH"
echo "Dataset: $DATASET_JSON (5,819 samples, 87% with tracking)"
echo "Output: $OUT_DIR"
echo "Rewards: motion_trajectory + all standard rewards"
echo "Motion Chain of Thought: ENABLED (learned in SFT)"
echo "=========================================="
echo ""
