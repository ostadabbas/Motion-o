...
#SBATCH --job-name=open-o3_grpo_v2
#SBATCH --mem=128GB
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --output=logs/open-o3_grpo_v2_%j.out
#SBATCH --error=logs/open-o3_grpo_v2_%j.err

set -euo pipefail

echo "=========================================="
echo "Open-o3 GRPO v2 — Baseline (no grounding)"
echo "2x H200 141GB"
echo "=========================================="
...
EXP_NAME="open-o3_grpo_v2_${SLURM_JOB_ID}"
...
# DATASET_JSON="${DATA_ROOT}/json_data/STGR-RL-open-o3-10k.json"
DATASET_JSON="${DATA_ROOT}/json_data/STGR-RL-open-o3-10k.json"
...
echo ""
echo "=========================================="
echo "Open-o3 GRPO v2 Baseline Complete! Model at: $OUT_DIR"
echo "End: $(date)"
echo "=========================================="