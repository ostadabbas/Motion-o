...
#SBATCH --job-name=motionr1_grpo_discrete
#SBATCH --mem=128GB
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --output=logs/grpo_discrete_%j.out
#SBATCH --error=logs/grpo_discrete_%j.err
...
# Change the SFT model path to the most updated one
MODEL_PATH="outputs/sft_h200_4403849/merged"
OUT_DIR="outputs/grpo_h200_chain_discrete"
DATA_ROOT="/scratch/bai.xiang/Open-o3-Video"
DATASET_JSON="${DATA_ROOT}/json_data/STGR-RL-filtered-motion-5k.json"
