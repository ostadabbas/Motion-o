#!/bin/bash
# SFT Training Script (Cold-start initialization)
# Using subset dataset with 5,696 available samples
...
echo "=========================================="
echo "Starting SFT Training (DeepSpeed ZeRO-2)"
echo "=========================================="
echo "Model: $MODEL_PATH"
echo "Dataset: $DATASET_JSON (5,696 samples)"
echo "Output: $OUT_DIR"
echo "GPUs: 4 (0,1,2,3)"
echo "DeepSpeed: configs/zero2.json (Open-o3-Video config)"
echo "=========================================="
echo ""
