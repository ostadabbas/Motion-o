#!/bin/bash
# GRPO Training - Baseline (without motion reward)
...
echo "=========================================="
echo "Starting Baseline GRPO Training"
echo "=========================================="
...
# Baseline: Train WITHOUT motion_trajectory reward (4 GPUs)
# Remove "motion_trajectory" from reward_funcs to establish baseline
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node="4" \
    ...
    # ⬆️ LoRA enabled + num_generations=2 - Note: NO motion_trajectory in baseline
