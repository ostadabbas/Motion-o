...
# Skips baseline - just trains the motion-aware model. Uses subset (filtered to available videos).

echo "=========================================="
echo "MotionR1 Training Pipeline (Motion Only)"
echo "=========================================="
echo "This will submit 2 jobs with dependencies:"
echo "1. SFT Training (5.7k samples with motion tags, ~6-8 hours)"
echo "2. GRPO Motion (5,819 samples, ~8-12 hours) - depends on SFT"
echo ""
echo "Dataset: Subset (motion-augmented, available videos only)"
